...
const plans = [
  ...
  },
  {
    ...
    type: "PLANS",
    description:
      "Create a vision to get started by imagining your dream life. ",
  },
  {
    title: "Focussed",
    rate: "11.20%",
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Generated by Ahmed Salah" />
          ...
          <section className={styles.headerSection}>
            <div className={styles.headerText}>
              <h1 className={styles.headerTitle}>
                Life Planning, Making <br /> Easy to Turn Dreams to Reality.
              </h1>
